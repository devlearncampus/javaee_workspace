        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">상품관리>상품 상세보기</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">상품 상세 내용</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<!-- ./wrapper -->
	...
	<script>
	function printCategory(obj, list, selectedValue){
	...
	function getTopCategory(selectedValue){
		$.ajax({
			...
			success:function(result, status, xhr){ //200번대의 성공 응답 시, 이 함수 실행
				...
				//화면에 출력하기 
				printCategory("#topcategory",result, selectedValue);
			},
   ...
   function regist(){
	...
	$(()=>{
	   ...
	   getTopCategory(<%=subcategory.getTopcategory().getTopcategory_id()%>); //상위 카테고리 가져오기 
	   getSubCategory(<%=subcategory.getSubcategory_id()%>);
